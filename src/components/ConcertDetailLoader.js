	...
	return (
		<div className="flex flex-col items-start justify-start w-full gap-5 sm:flex-col lg:flex-row lg:gap-14">
			...
			<div className="concert-details w-full md:w-[70%] md:mx-auto lg:w-[30%]">
				<div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4 ml-auto"></div>
				<div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-[70%] mb-4 ml-auto"></div>
				...
				<div className="h-[45px] bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4 ml-auto mt-10"></div>
			</div>
		</div>
	);
};
