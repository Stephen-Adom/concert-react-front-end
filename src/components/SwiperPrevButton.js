...
const SwiperPrevButton = ({ swiper, disablePrevButton }) => (
  <button
    type="button"
    className={`swiper-btn swiper-button-prev swiper-button-disabled top-[50%] left-0 rounded-tr-full rounded-br-full justify-end ${disablePrevButton ? 'bg-[#efefef]' : 'bg-primaryGreen'
    }`}
