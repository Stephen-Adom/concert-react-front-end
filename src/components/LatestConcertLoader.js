	...
	return (
		<div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
			<div className="flex flex-col items-center justify-center gap-y-5">
				...
				<div className="h-2.5 bg-gray-200 rounded-full animate-pulse w-32"></div>
				<div className="h-1 bg-gray-200 rounded-full animate-pulse w-52"></div>
				<div className="h-20 bg-gray-200 rounded-sm animate-pulse w-48"></div>
