	...
	return (
		<div
			...
			<div className="flex flex-col items-center justify-center min-h-screen bg-black bg-opacity-60">
				...
				<form
					class="w-full max-w-lg p-12 border border-gray-300 bg-gray-100 rounded-lg bg-opacity-10"
					onSubmit={handleFormSubmit}>
					<div class="mb-4">
						<label
							for="name"
							class="block mb-2 text-md font-bold text-white dark:text-white">
							Your Name
						</label>
						<input
							type="text"
					...
					<button
						type="submit"
						class="text-white bg-primaryGreen hover:bg-primaryGreenDark focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
						Submit
					</button>
					<Link
						to="/"
						class="text-primaryGreen font-medium py-2 flex items-center gap-2">
						<FaArrowLeft /> Go Back
					</Link>
				</form>
