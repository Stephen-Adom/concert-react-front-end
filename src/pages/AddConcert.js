...
const AddConcert = () => {
	...
	const setStepperLinkStyle = () => {
		return `flex md:w-full items-centersm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10`;
	};
	...
	return (
		<div className="w-full h-screen">
			<section className="flex flex-col items-center justify-start h-full py-10 text-center md:justify-center md:py-0">
				...
				<div className="w-full md:!w-[70%] lg:!w-[70%] xl:!w-[70%] mx-auto mt-10">
					<ol className="flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
						...
						>
							<span className="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
								{renderStepStatus(1)}
								Concert <span className="hidden sm:inline-flex sm:ml-2">Info</span>
							</span>
						</li>
						<li
							className={`${setStepperLinkStyle()} ${
						...
						>
							<span className="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
								{renderStepStatus(2)}
								Location <span className="hidden sm:inline-flex sm:ml-2">Info</span>
							</span>
						</li>
						<li
							className={`${setStepperLinkStyle()} ${
